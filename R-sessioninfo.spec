...
Version  : 1.2.0
Release  : 27
URL      : https://cran.r-project.org/src/contrib/sessioninfo_1.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sessioninfo_1.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635784664
...
/usr/lib64/R/library/sessioninfo/tests/test-env.R
/usr/lib64/R/library/sessioninfo/tests/test-env.Rout.save
