...
Version  : 1.1.0
Release  : 1
URL      : https://cran.r-project.org/src/contrib/sessioninfo_1.1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sessioninfo_1.1.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1540740112
